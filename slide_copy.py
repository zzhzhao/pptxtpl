...
# 注意：duplicate_slide方法能够复制带有chart（统计图表）的幻灯片
#      但是，幻灯片版本目前仅仅支持wps 2023上实验成功，在office没试验过
#      在word 2007实验失败，项目中的example.pptx模板正式word 2007生成，暂不支持
if __name__ == "__main__":
    import pptx
    presentation = pptx.Presentation("./example.pptx")
    duplicate_slide(presentation, 1)
    presentation.save("./save_example.pptx")
